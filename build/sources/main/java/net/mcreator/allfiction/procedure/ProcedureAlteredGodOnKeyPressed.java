...
import net.mcreator.allfiction.potion.PotionRage;
import net.mcreator.allfiction.ElementsAllfiction;

import java.util.Iterator;

@ElementsAllfiction.ModElement.Tag
public class ProcedureAlteredGodOnKeyPressed extends ElementsAllfiction.ModElement {
	public ProcedureAlteredGodOnKeyPressed(ElementsAllfiction instance) {
		super(instance, 29);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure AlteredGodOnKeyPressed!");
			return;
		}
		...
		if ((((entity instanceof EntityPlayerMP) && (entity.world instanceof WorldServer))
			...
			if (entity instanceof EntityLivingBase)
				((EntityLivingBase) entity).addPotionEffect(new PotionEffect(PotionRage.potion, (int) 1000000, (int) 1, (false), (false)));
