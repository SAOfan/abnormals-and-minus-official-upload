...
import net.mcreator.allfiction.procedure.ProcedureAlteredGodOnKeyPressed;
...
public class KeyBindingAbnormalitykey extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingAbnormalitykey(ElementsAllfiction instance) {
		super(instance, 15);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.abnormalitykey", Keyboard.KEY_NONE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureAlteredGodOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
