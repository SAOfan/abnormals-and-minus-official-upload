...
import net.mcreator.allfiction.procedure.ProcedureAbnormality2OnKeyPressed;
...
public class KeyBindingAbnormality2 extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingAbnormality2(ElementsAllfiction instance) {
		super(instance, 30);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.abnormality2", Keyboard.KEY_NONE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureAbnormality2OnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
