...
import net.mcreator.allfiction.procedure.ProcedureStoryroleOnKeyPressed;
...
public class KeyBindingStoryrole extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingStoryrole(ElementsAllfiction instance) {
		super(instance, 45);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.storyrole", Keyboard.KEY_COLON, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureStoryroleOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
