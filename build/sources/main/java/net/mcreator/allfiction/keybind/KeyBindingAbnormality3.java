...
import net.mcreator.allfiction.procedure.ProcedureAbnormality3OnKeyPressed;
...
public class KeyBindingAbnormality3 extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingAbnormality3(ElementsAllfiction instance) {
		super(instance, 31);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.abnormality3", Keyboard.KEY_NONE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureAbnormality3OnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
