...
import net.mcreator.allfiction.procedure.ProcedureZeroOnKeyPressed;
...
public class KeyBindingZero extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingZero(ElementsAllfiction instance) {
		super(instance, 46);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.zero", Keyboard.KEY_NONE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureZeroOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
