...
import net.mcreator.allfiction.procedure.ProcedureAbnormality4OnKeyPressed;
...
public class KeyBindingAbnormality4 extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingAbnormality4(ElementsAllfiction instance) {
		super(instance, 34);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.abnormality4", Keyboard.KEY_NONE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureAbnormality4OnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
