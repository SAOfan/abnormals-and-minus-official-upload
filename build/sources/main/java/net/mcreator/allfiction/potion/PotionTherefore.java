...
public class PotionTherefore extends ElementsAllfiction.ModElement {
	@GameRegistry.ObjectHolder("allfiction:therefore")
	public static final Potion potion = null;
	@GameRegistry.ObjectHolder("allfiction:therefore")
	public static final PotionType potionType = null;
	public PotionTherefore(ElementsAllfiction instance) {
		super(instance, 48);
	}
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			...
			setBeneficial();
			setRegistryName("therefore");
			setPotionName("effect.therefore");
			potionIcon = new ResourceLocation("allfiction:textures/mob_effect/therefore.png");
		}
