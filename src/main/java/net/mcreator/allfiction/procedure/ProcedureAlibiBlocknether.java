...
public class ProcedureAlibiBlocknether extends ElementsAllfiction.ModElement {
	public ProcedureAlibiBlocknether(ElementsAllfiction instance) {
		super(instance, 63);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure AlibiBlocknether!");
			return;
		}
