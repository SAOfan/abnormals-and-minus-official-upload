...
public class ProcedureAlibiBlockend extends ElementsAllfiction.ModElement {
	public ProcedureAlibiBlockend(ElementsAllfiction instance) {
		super(instance, 62);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure AlibiBlockend!");
			return;
		}
