...
import net.mcreator.allfiction.procedure.ProcedureAllfictionkeyOnKeyPressed;
...
public class KeyBindingAllfictionkey extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingAllfictionkey(ElementsAllfiction instance) {
		super(instance, 5);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.allfictionkey", Keyboard.KEY_NONE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureAllfictionkeyOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
