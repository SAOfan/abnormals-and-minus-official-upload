...
import net.mcreator.allfiction.procedure.ProcedureGiveupdown;
...
public class KeyBindingSkillthree extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingSkillthree(ElementsAllfiction instance) {
		super(instance, 52);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.skillthree", Keyboard.KEY_NONE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureGiveupdown.executeProcedure($_dependencies);
		}
	}
}
