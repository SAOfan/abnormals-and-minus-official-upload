...
import net.mcreator.allfiction.procedure.ProcedureAbnormality5OnKeyPressed;
...
public class KeyBindingAbnormality5 extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingAbnormality5(ElementsAllfiction instance) {
		super(instance, 37);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.abnormality5", Keyboard.KEY_NONE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureAbnormality5OnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
