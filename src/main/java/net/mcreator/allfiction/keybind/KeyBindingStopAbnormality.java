...
import net.mcreator.allfiction.procedure.ProcedureStopAbnormalityOnKeyPressed;
...
public class KeyBindingStopAbnormality extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingStopAbnormality(ElementsAllfiction instance) {
		super(instance, 25);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.stopabnormality", Keyboard.KEY_NONE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureStopAbnormalityOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
