...
import net.mcreator.allfiction.procedure.ProcedureAlibi_Blockkey;
...
public class KeyBindingSkillone extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingSkillone(ElementsAllfiction instance) {
		super(instance, 52);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.skillone", Keyboard.KEY_NONE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureAlibi_Blockkey.executeProcedure($_dependencies);
		}
	}
}
