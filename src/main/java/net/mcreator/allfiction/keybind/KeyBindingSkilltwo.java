...
import net.mcreator.allfiction.procedure.ProcedureLifeZero;
...
public class KeyBindingSkilltwo extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingSkilltwo(ElementsAllfiction instance) {
		super(instance, 52);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.skilltwo", Keyboard.KEY_NONE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureLifeZero.executeProcedure($_dependencies);
		}
	}
}
