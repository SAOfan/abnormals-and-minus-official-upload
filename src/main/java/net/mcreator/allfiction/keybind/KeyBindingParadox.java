...
import net.mcreator.allfiction.procedure.ProcedureParadocsOnKeyPressed;
...
public class KeyBindingParadox extends ElementsAllfiction.ModElement {
	private KeyBinding keys;
	public KeyBindingParadox(ElementsAllfiction instance) {
		super(instance, 50);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.paradox", Keyboard.KEY_NONE, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureParadocsOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
