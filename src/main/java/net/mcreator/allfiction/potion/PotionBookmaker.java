...
public class PotionBookmaker extends ElementsAllfiction.ModElement {
	@GameRegistry.ObjectHolder("allfiction:bookmaker")
	public static final Potion potion = null;
	@GameRegistry.ObjectHolder("allfiction:bookmaker")
	public static final PotionType potionType = null;
	public PotionBookmaker(ElementsAllfiction instance) {
		super(instance, 13);
	}
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			super(true, -1);
			setRegistryName("bookmaker");
			setPotionName("effect.bookmaker");
			potionIcon = new ResourceLocation("allfiction:textures/mob_effect/bookmaker.png");
		}
