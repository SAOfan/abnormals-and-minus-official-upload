...
public class PotionParadocs extends ElementsAllfiction.ModElement {
	@GameRegistry.ObjectHolder("allfiction:paradocs")
	public static final Potion potion = null;
	@GameRegistry.ObjectHolder("allfiction:paradocs")
	public static final PotionType potionType = null;
	public PotionParadocs(ElementsAllfiction instance) {
		super(instance, 50);
	}
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			...
			setBeneficial();
			setRegistryName("paradocs");
			setPotionName("effect.paradocs");
			potionIcon = new ResourceLocation("allfiction:textures/mob_effect/paradocs.png");
		}
