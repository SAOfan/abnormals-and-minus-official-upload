...
public class GuiFiveFocusDesc extends ElementsAllfiction.ModElement {
	public static int GUIID = 10;
	public static HashMap guistate = new HashMap();
	public GuiFiveFocusDesc(ElementsAllfiction instance) {
		super(instance, 76);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("allfiction:textures/fivefocusdesc.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			...
			this.fontRenderer.drawString("Gives the player the ability", 7, 29, -16777216);
			this.fontRenderer.drawString("to inflict disease", 7, 38, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 124, this.guiTop + 137, 40, 20, "Back"));
		}
