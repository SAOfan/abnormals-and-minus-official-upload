...
public class GuiGiveUpDownDesc extends ElementsAllfiction.ModElement {
	public static int GUIID = 9;
	public static HashMap guistate = new HashMap();
	public GuiGiveUpDownDesc(ElementsAllfiction instance) {
		super(instance, 76);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("allfiction:textures/giveupdowndesc.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Description", 61, 11, -16777216);
			this.fontRenderer.drawString("Gives the player the ability to", 7, 29, -16777216);
			this.fontRenderer.drawString("cling onto ceilings", 7, 38, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 115, this.guiTop + 137, 40, 20, "Back"));
		}
