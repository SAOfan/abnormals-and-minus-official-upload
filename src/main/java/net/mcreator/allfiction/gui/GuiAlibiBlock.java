...
public class GuiAlibiBlock extends ElementsAllfiction.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiAlibiBlock(ElementsAllfiction instance) {
		super(instance, 54);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("allfiction:textures/alibiblock.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("what type?", 60, 23, -16777216);
		}
		...
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureAlibiBlockDimensionswap.executeProcedure($_dependencies);
			}
		}
	}
