...
public class GuiDeadLockdesc extends ElementsAllfiction.ModElement {
	public static int GUIID = 7;
	public static HashMap guistate = new HashMap();
	public GuiDeadLockdesc(ElementsAllfiction instance) {
		super(instance, 73);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("allfiction:textures/deadlockdesc.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Description", 80, 11, -16777216);
			this.fontRenderer.drawString("Gives the player ability to survive ", 8, 29, -16777216);
			this.fontRenderer.drawString("things that most other people could not", 8, 38, -16777216);
		}
		...
		public void initGui() {
			super.initGui();
			this.guiLeft = (this.width - 215) / 2;
			this.guiTop = (this.height - 166) / 2;
			Keyboard.enableRepeatEvents(true);
			this.buttonList.clear();
			this.buttonList.add(new GuiButton(0, this.guiLeft + 134, this.guiTop + 137, 40, 20, "Back"));
		}
